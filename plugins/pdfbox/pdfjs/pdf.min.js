...
default:return!1}};PDFJS.shadow=Q;var ea=PDFJS.PasswordResponses={NEED_PASSWORD:1,INCORRECT_PASSWORD:2},X=function(){function b(a,d){this.name="PasswordException";this.message=a;this.code=d}b.prototype=Error();return b.constructor=b}();PDFJS.PasswordException=X;var fa=function(){function b(a,d){this.name="UnknownErrorException";this.message=a;this.details=d}b.prototype=Error();return b.constructor=b}();PDFJS.UnknownErrorException=fa;var ga=function(){function b(a){this.name="InvalidPDFException";
this.message=a}b.prototype=Error();return b.constructor=b}();PDFJS.InvalidPDFException=ga;var ha=function(){function b(a){this.name="MissingPDFException";this.message=a}b.prototype=Error();return b.constructor=b}();PDFJS.MissingPDFException=ha;var ia=function(){function b(a,d){this.name="UnexpectedResponseException";this.message=a;this.status=d}b.prototype=Error();return b.constructor=b}();PDFJS.UnexpectedResponseException=ia;(function(){function b(a){this.message=a}b.prototype=Error();b.prototype.name=
"NotImplementedException";return b.constructor=b})();(function(){function b(a,d){this.begin=a;this.end=d;this.message="Missing data ["+a+", "+d+")"}b.prototype=Error();b.prototype.name="MissingDataException";return b.constructor=b})();(function(){function b(a){this.message=a}b.prototype=Error();b.prototype.name="XRefParseException";return b.constructor=b})();Object.defineProperty(PDFJS,"isLittleEndian",{configurable:!0,get:function(){var b=PDFJS,a=new Uint8Array(2);a[0]=1;a=new Uint16Array(a.buffer);
return Q(b,"isLittleEndian",1===a[0])}});Object.defineProperty(PDFJS,"hasCanvasTypedArrays",{configurable:!0,get:function(){var b=PDFJS,a=document.createElement("canvas");a.width=a.height=1;a=a.getContext("2d").createImageData(1,1);return Q(b,"hasCanvasTypedArrays","undefined"!==typeof a.data.buffer)}});var sa=function(){function b(c,f){this.buffer=c;this.byteLength=c.length;for(var e=this.length=void 0===f?this.byteLength>>2:f;d<e;)Object.defineProperty(b.prototype,d,a(d)),d++}function a(d){return{get:function(){var a=
...
a.dontFlip)},convertToViewportPoint:function(a,d){return C.applyTransform([a,d],this.transform)},convertToViewportRectangle:function(a){var d=C.applyTransform([a[0],a[1]],this.transform);a=C.applyTransform([a[2],a[3]],this.transform);return[d[0],d[1],a[0],a[1]]},convertToPdfPoint:function(a,d){return C.applyInverseTransform([a,d],this.transform)}};return b}();PDFJS.createPromiseCapability=H;(function(){function b(a){this._status=0;this._handlers=[];try{a.call(this,this._resolve.bind(this),this._reject.bind(this))}catch(b){this._reject(b)}}
...
!1;for(var b=0;b<this.unhandledRejections.length;b++)this.unhandledRejections[b].promise===a&&(this.unhandledRejections.splice(b),b--)},scheduleRejectionCheck:function(){this.pendingRejectionCheck||(this.pendingRejectionCheck=!0,setTimeout(function(){this.pendingRejectionCheck=!1;for(var a=Date.now(),b=0;b<this.unhandledRejections.length;b++)if(500<a-this.unhandledRejections[b].time){var f=this.unhandledRejections[b].promise._value,e="Unhandled rejection: "+f;f.stack&&(e+="\n"+f.stack);v(e);this.unhandledRejections.splice(b);
b--}this.unhandledRejections.length&&this.scheduleRejectionCheck()}.bind(this),500))}};b.all=function(a){function c(a){2!==g._status&&(h=[],e(a))}var f,e,g=new b(function(a,r){f=a;e=r}),l=a.length,h=[];if(0===l)return f(h),g;for(var k=0,n=a.length;k<n;++k){var w=a[k],r=function(a){return function(r){2!==g._status&&(h[a]=r,l--,0===l&&f(h))}}(k);b.isPromise(w)?w.then(r,c):r(w)}return g};b.isPromise=function(a){return a&&"function"===typeof a.then};b.resolve=function(a){return new b(function(b){b(a)})};
...
1<f?(g&15)<<2|l>>6:64]+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="[c+2<f?l&63:64]);return d}}();U.prototype={on:function(b,a,d){var c=this.actionHandler;c[b]&&x('There is already an actionName called "'+b+'"');c[b]=[a,d]},send:function(b,a,d){this.postMessage({action:b,data:a},d)},sendWithPromise:function(b,a,d){var c=this.callbackIndex++;b={action:b,data:a,callbackId:c};a=H();this.callbacksCapabilities[c]=a;try{this.postMessage(b,d)}catch(f){a.reject(f)}return a.promise},
...
getViewport:function(a,b){2>arguments.length&&(b=this.rotate);return new PDFJS.PageViewport(this.view,a,b,0,0)},getAnnotations:function(){if(this.annotationsPromise)return this.annotationsPromise;var a=this.transport.getAnnotations(this.pageIndex);return this.annotationsPromise=a},render:function(a){function b(a){var d=e.renderTasks.indexOf(g);0<=d&&e.renderTasks.splice(d,1);l.cleanupAfterRender&&(l.pendingDestroy=!0);l._tryDestroy();a?g.capability.reject(a):g.capability.resolve();c.timeEnd("Rendering");
c.timeEnd("Overall")}var c=this.stats;c.time("Overall");this.pendingDestroy=!1;var f="print"===a.intent?"print":"display";this.intentStates[f]||(this.intentStates[f]={});var e=this.intentStates[f];e.displayReadyCapability||(e.receivingOperatorList=!0,e.displayReadyCapability=H(),e.operatorList={fnArray:[],argsArray:[],lastChunk:!1},this.stats.time("Page Request"),this.transport.messageHandler.send("RenderPageRequest",{pageIndex:this.pageNumber-1,intent:f}));var g=new xa(b,a,this.objs,this.commonObjs,
e.operatorList,this.pageNumber);e.renderTasks||(e.renderTasks=[]);e.renderTasks.push(g);f=g.task;a.continueCallback&&(f.onContinue=a.continueCallback);var l=this;e.displayReadyCapability.promise.then(function(a){l.pendingDestroy?b():(c.time("Rendering"),g.initalizeGraphics(a),g.operatorListChanged())},function(a){b(a)});return f},getOperatorList:function(){function a(){b.operatorList.lastChunk&&b.opListReadCapability.resolve(b.operatorList)}this.intentStates.oplist||(this.intentStates.oplist={});
var b=this.intentStates.oplist;if(!b.opListReadCapability){var c={};c.operatorListChanged=a;b.receivingOperatorList=!0;b.opListReadCapability=H();b.renderTasks=[];b.renderTasks.push(c);b.operatorList={fnArray:[],argsArray:[],lastChunk:!1};this.transport.messageHandler.send("RenderPageRequest",{pageIndex:this.pageIndex,intent:"oplist"})}return b.opListReadCapability.promise},getTextContent:function(){return this.transport.messageHandler.sendWithPromise("GetTextContent",{pageIndex:this.pageNumber-1})},
...
_renderPageChunk:function(a,b){var c=this.intentStates[b],f,e;f=0;for(e=a.length;f<e;f++)c.operatorList.fnArray.push(a.fnArray[f]),c.operatorList.argsArray.push(a.argsArray[f]);c.operatorList.lastChunk=a.lastChunk;for(f=0;f<c.renderTasks.length;f++)c.renderTasks[f].operatorListChanged();a.lastChunk&&(c.receivingOperatorList=!1,this._tryDestroy())}};return b}(),va=function(){function b(a,b){this.pdfDataRangeTransport=b;this.workerInitializedCapability=a;this.commonObjs=new ja;this.loadingTask=null;
this.pageCache=[];this.pagePromises=[];this.downloadInfoCapability=H();if(!p.PDFJS.disableWorker&&"undefined"!==typeof Worker){var c=PDFJS.workerSrc;c||x("No PDFJS.workerSrc specified");try{var f=new Worker(c),e=new U("main",f);this.messageHandler=e;e.on("test",function(b){b&&b.supportTypedArray?(this.worker=f,b.supportTransfers||(PDFJS.postMessageTransfers=!1),this.setupMessageHandler(e),a.resolve()):this.setupFakeWorker()}.bind(this));var g=new Uint8Array([PDFJS.postMessageTransfers?255:0]);try{e.send("test",
g,[g.buffer])}catch(l){O("Cannot use postMessage transfers"),g[0]=0,e.send("test",g)}return}catch(h){O("The worker has been disabled.")}}this.setupFakeWorker()}b.prototype={destroy:function(){this.pageCache=[];this.pagePromises=[];var a=this;this.messageHandler.sendWithPromise("Terminate",null).then(function(){N.clear();a.worker&&a.worker.terminate()})},setupFakeWorker:function(){p.PDFJS.disableWorker=!0;PDFJS.fakeWorkerFilesLoadedCapability||(PDFJS.fakeWorkerFilesLoadedCapability=H(),C.loadScript(PDFJS.workerSrc,
function(){PDFJS.fakeWorkerFilesLoadedCapability.resolve()}));PDFJS.fakeWorkerFilesLoadedCapability.promise.then(function(){v("Setting up fake worker.");var a={postMessage:function(b){a.onmessage({data:b})},terminate:function(){}},b=new U("main",a);this.setupMessageHandler(b);PDFJS.WorkerMessageHandler.setup(b);this.workerInitializedCapability.resolve()}.bind(this))},setupMessageHandler:function(a){function b(d){a.send("UpdatePassword",d)}this.messageHandler=a;var c=this.pdfDataRangeTransport;c&&
(c.addRangeListener(function(b,d){a.send("OnDataRange",{begin:b,chunk:d})}),c.addProgressListener(function(b){a.send("OnDataProgress",{loaded:b})}),c.addProgressiveReadListener(function(b){a.send("OnDataRange",{chunk:b})}),a.on("RequestDataRange",function(a){c.requestDataRange(a.begin,a.end)},this));a.on("GetDoc",function(a){var b=a.pdfInfo;this.numPages=a.pdfInfo.numPages;this.pdfDocument=a=new wa(b,this);this.loadingTask._capability.resolve(a)},this);a.on("NeedPassword",function(a){var c=this.loadingTask;
if(c.onPassword)return c.onPassword(b,ea.NEED_PASSWORD);c._capability.reject(new X(a.message,a.code))},this);a.on("IncorrectPassword",function(a){var c=this.loadingTask;if(c.onPassword)return c.onPassword(b,ea.INCORRECT_PASSWORD);c._capability.reject(new X(a.message,a.code))},this);a.on("InvalidPDF",function(a){this.loadingTask._capability.reject(new ga(a.message))},this);a.on("MissingPDF",function(a){this.loadingTask._capability.reject(new ha(a.message))},this);a.on("UnexpectedResponse",function(a){this.loadingTask._capability.reject(new ia(a.message,
a.status))},this);a.on("UnknownError",function(a){this.loadingTask._capability.reject(new fa(a.message,a.details))},this);a.on("DataLoaded",function(a){this.downloadInfoCapability.resolve(a)},this);a.on("PDFManagerReady",function(a){this.pdfDataRangeTransport&&this.pdfDataRangeTransport.transportReady()},this);a.on("StartRenderPage",function(a){var b=this.pageCache[a.pageIndex];b.stats.timeEnd("Page Request");b._startRenderPage(a.transparency,a.intent)},this);a.on("RenderPageChunk",function(a){this.pageCache[a.pageIndex]._renderPageChunk(a.operatorList,
a.intent)},this);a.on("commonobj",function(a){var b=a[0],d=a[1];if(!this.commonObjs.hasData(b))switch(d){case "Font":a=a[2];var c;if("error"in a){var h=a.error;v("Error during font loading: "+h);this.commonObjs.resolve(b,h);break}else c=new za(a);N.bind([c],function(a){this.commonObjs.resolve(b,c)}.bind(this));break;case "FontPath":this.commonObjs.resolve(b,a[2]);break;default:h("Got unknown common object type "+d)}},this);a.on("obj",function(a){var b=a[0],d=a[2],c=this.pageCache[a[1]];if(!c.objs.hasData(b))switch(d){case "JpegStream":a=
a[3];qa(b,a,c.objs);break;case "Image":a=a[3];c.objs.resolve(b,a);a&&"data"in a&&8E6<a.data.length&&(c.cleanupAfterRender=!0);break;default:x("Got unknown object type "+d)}},this);a.on("DocProgress",function(a){var b=this.loadingTask;if(b.onProgress)b.onProgress({loaded:a.loaded,total:a.total})},this);a.on("PageError",function(a){var b=this.pageCache[a.pageNum-1].intentStates[a.intent];b.displayReadyCapability?b.displayReadyCapability.reject(a.error):x(a.error)},this);a.on("JpegDecode",function(a){var b=
a[0],d=a[1];return 3!==d&&1!==d?Promise.reject(Error("Only 3 components or 1 component can be returned")):new Promise(function(a,c){var k=new Image;k.onload=function(){var b=k.width,w=k.height,r=b*w,c=4*r,r=new Uint8Array(r*d),h=ba(b,w).getContext("2d");h.drawImage(k,0,0);var h=h.getImageData(0,0,b,w).data,q,e;if(3===d)for(e=q=0;q<c;q+=4,e+=3)r[e]=h[q],r[e+1]=h[q+1],r[e+2]=h[q+2];else if(1===d)for(e=q=0;q<c;q+=4,e++)r[e]=h[q];a({data:r,width:b,height:w})};k.onerror=function(){c(Error("JpegDecode failed to load image"))};
k.src=b})})},fetchDocument:function(a,b){this.loadingTask=a;b.disableAutoFetch=PDFJS.disableAutoFetch;b.disableStream=PDFJS.disableStream;b.chunkedViewerLoading=!!this.pdfDataRangeTransport;this.pdfDataRangeTransport&&(b.length=this.pdfDataRangeTransport.length,b.initialData=this.pdfDataRangeTransport.initialData);this.messageHandler.send("GetDocRequest",{source:b,disableRange:PDFJS.disableRange,maxImageSize:PDFJS.maxImageSize,cMapUrl:PDFJS.cMapUrl,cMapPacked:PDFJS.cMapPacked,disableFontFace:PDFJS.disableFontFace,
disableCreateObjectURL:PDFJS.disableCreateObjectURL,verbosity:PDFJS.verbosity})},getData:function(){return this.messageHandler.sendWithPromise("GetData",null)},getPage:function(a,b){if(0>=a||a>this.numPages||(a|0)!==a)return Promise.reject(Error("Invalid page request"));var c=a-1;if(c in this.pagePromises)return this.pagePromises[c];var f=this.messageHandler.sendWithPromise("GetPage",{pageIndex:c}).then(function(a){a=new ya(c,a,this);return this.pageCache[c]=a}.bind(this));return this.pagePromises[c]=
...
c&&c.destroy()}this.commonObjs.clear();N.clear()}.bind(this))}};return b}(),ja=function(){function b(){this.objs={}}b.prototype={ensureObj:function(a){if(this.objs[a])return this.objs[a];var b={capability:H(),data:null,resolved:!1};return this.objs[a]=b},get:function(a,b){if(b)return this.ensureObj(a).capability.promise.then(b),null;var c=this.objs[a];c&&c.resolved||x("Requesting object that isn't resolved yet "+a);return c.data},resolve:function(a,b){var c=this.ensureObj(a);c.resolved=!0;c.data=
...
d.charCodeAt(l+1),g=g+("&#x"+(65536+h).toString(16).substring(1)+";");return">"+g})}function a(a){"string"===typeof a?(a=b(a),a=(new DOMParser).parseFromString(a,"application/xml")):a instanceof Document||x("Metadata: Invalid metadata object");this.metaDocument=a;this.metadata={};this.parse()}a.prototype={parse:function(){var a=this.metaDocument.documentElement;if("rdf:rdf"!==a.nodeName.toLowerCase())for(a=a.firstChild;a&&"rdf:rdf"!==a.nodeName.toLowerCase();)a=a.nextSibling;var b=a?a.nodeName.toLowerCase():
null;if(a&&"rdf:rdf"===b&&a.hasChildNodes()){var a=a.childNodes,f,e,g,l,h,k;g=0;for(h=a.length;g<h;g++)if(b=a[g],"rdf:description"===b.nodeName.toLowerCase())for(l=0,k=b.childNodes.length;l<k;l++)"#text"!==b.childNodes[l].nodeName.toLowerCase()&&(f=b.childNodes[l],e=f.nodeName.toLowerCase(),this.metadata[e]=f.textContent.trim())}},get:function(a){return this.metadata[a]||null},has:function(a){return"undefined"!==typeof this.metadata[a]}};return a}();var L=function(){var b={};return{getCanvas:function(a,
d,c,f){void 0!==b[a]?(a=b[a],a.canvas.width=d,a.canvas.height=c,a.context.setTransform(1,0,0,1,0,0)):(d=ba(d,c),c=d.getContext("2d"),f&&ca(c),b[a]=a={canvas:d,context:c});return a},clear:function(){for(var a in b){var d=b[a];d.canvas.width=0;d.canvas.height=0;delete b[a]}}}}(),la=function(){function b(a){this.alphaIsShape=!1;this.fontSize=0;this.fontSizeScale=1;this.textMatrix=P;this.textMatrixScale=1;this.fontMatrix=S;this.wordSpacing=this.charSpacing=this.lineY=this.lineX=this.y=this.x=this.leading=
...
c;this.imageLayer=h;this.groupStack=[];this.baseTransform=this.processingType3=null;this.baseTransformStack=[];this.groupLevel=0;this.smaskStack=[];this.smaskCounter=0;this.tempSMask=null;a&&ca(a);this.cachedGetSinglePixelWidth=null}function a(a,b){if("undefined"!==typeof ImageData&&b instanceof ImageData)a.putImageData(b,0,0);else{var c=b.height,h=b.width,d=c%16,c=(c-d)/16,k=0===d?c:c+1,n=a.createImageData(h,16),e=0,g,l=b.data,f=n.data,u,y,m;if(1===b.kind){var E=l.byteLength,f=PDFJS.hasCanvasTypedArrays?
new Uint32Array(f.buffer):new sa(f),B=f.length,D=h+7>>3,A=PDFJS.isLittleEndian||!PDFJS.hasCanvasTypedArrays?4278190080:255;for(u=0;u<k;u++){m=u<c?16:d;for(y=g=0;y<m;y++){for(var p=E-e,C=0,p=p>D?h:8*p-7,I=p&-8,F=0,M=0;C<I;C+=8)M=l[e++],f[g++]=M&128?4294967295:A,f[g++]=M&64?4294967295:A,f[g++]=M&32?4294967295:A,f[g++]=M&16?4294967295:A,f[g++]=M&8?4294967295:A,f[g++]=M&4?4294967295:A,f[g++]=M&2?4294967295:A,f[g++]=M&1?4294967295:A;for(;C<p;C++)0===F&&(M=l[e++],F=128),f[g++]=M&F?4294967295:A,F>>=1}for(;g<
B;)f[g++]=0;a.putImageData(n,0,16*u)}}else if(3===b.kind){y=0;m=64*h;for(u=0;u<c;u++)f.set(l.subarray(e,e+m)),e+=m,a.putImageData(n,0,y),y+=16;u<k&&(f.set(l.subarray(e,e+h*d*4)),a.putImageData(n,0,y))}else if(2===b.kind)for(m=16*h,u=0;u<k;u++){u>=c&&(m=d,m*=h);g=0;for(y=m;y--;)f[g++]=l[e++],f[g++]=l[e++],f[g++]=l[e++],f[g++]=255;a.putImageData(n,0,16*u)}else x("bad image kind: "+b.kind)}}function d(a,b){for(var c=b.height,h=b.width,d=c%16,c=(c-d)/16,k=0===d?c:c+1,n=a.createImageData(h,16),e=0,g=b.data,
f=n.data,l=0;l<k;l++){for(var u=l<c?16:d,m=3,G=0;G<u;G++)for(var E=0,B=0;B<h;B++){if(!E)var D=g[e++],E=128;f[m]=D&E?0:255;m+=4;E>>=1}a.putImageData(n,0,16*l)}}function c(a,b){for(var c="strokeStyle fillStyle fillRule globalAlpha lineWidth lineCap lineJoin miterLimit globalCompositeOperation font".split(" "),h=0,d=c.length;h<d;h++){var k=c[h];void 0!==a[k]&&(b[k]=a[k])}void 0!==a.setLineDash?(b.setLineDash(a.getLineDash()),b.lineDashOffset=a.lineDashOffset):void 0!==a.mozDashOffset&&(b.mozDash=a.mozDash,
b.mozDashOffset=a.mozDashOffset)}function f(a,b){for(var c=a.length,h=1/255,d=3;d<c;d+=4)b[d]=b[d]*a[d]*h|0}function e(a,b){for(var c=a.length,h=3;h<c;h+=4)b[h]=b[h]*(77*a[h-3]+152*a[h-2]+28*a[h-1])>>16}var g=["butt","round","square"],l=["miter","round","bevel"],h={},k={};b.prototype={beginDrawing:function(a,b){var c=this.ctx.canvas.width,h=this.ctx.canvas.height;b?this.ctx.clearRect(0,0,c,h):(this.ctx.mozOpaque=!0,this.ctx.save(),this.ctx.fillStyle="rgb(255, 255, 255)",this.ctx.fillRect(0,0,c,h),
this.ctx.restore());c=a.transform;this.ctx.save();this.ctx.transform.apply(this.ctx,c);this.baseTransform=this.ctx.mozCurrentTransform.slice();this.imageLayer&&this.imageLayer.beginLayout()},executeOperatorList:function(a,b,c,h){var d=a.argsArray;a=a.fnArray;b=b||0;var k=d.length;if(k===b)return b;for(var n=10<k-b&&"function"===typeof c,e=n?Date.now()+15:0,g=0,f=this.commonObjs,l=this.objs,u;;){if(void 0!==h&&b===h.nextBreakPoint)return h.breakIt(b,c),b;u=a[b];if(u!==m.dependency)this[u].apply(this,
d[b]);else{u=d[b];for(var y=0,G=u.length;y<G;y++){var E=u[y],B="g"===E[0]&&"_"===E[1]?f:l;if(!B.isResolved(E))return B.get(E,c),b}}b++;if(b===k)return b;if(n&&10<++g){if(Date.now()>e)return c(),b;g=0}}},endDrawing:function(){this.ctx.restore();L.clear();T.clear();this.imageLayer&&this.imageLayer.endLayout()},setLineWidth:function(a){this.current.lineWidth=a;this.ctx.lineWidth=a},setLineCap:function(a){this.ctx.lineCap=g[a]},setLineJoin:function(a){this.ctx.lineJoin=l[a]},setMiterLimit:function(a){this.ctx.miterLimit=
a},setDash:function(a,b){var c=this.ctx;void 0!==c.setLineDash?(c.setLineDash(a),c.lineDashOffset=b):(c.mozDash=a,c.mozDashOffset=b)},setRenderingIntent:function(a){},setFlatness:function(a){},setGState:function(a){for(var b=0,c=a.length;b<c;b++){var h=a[b],d=h[1];switch(h[0]){case "LW":this.setLineWidth(d);break;case "LC":this.setLineCap(d);break;case "LJ":this.setLineJoin(d);break;case "ML":this.setMiterLimit(d);break;case "D":this.setDash(d[0],d[1]);break;case "RI":this.setRenderingIntent(d);break;
case "FL":this.setFlatness(d);break;case "Font":this.setFont(d[0],d[1]);break;case "CA":this.current.strokeAlpha=h[1];break;case "ca":this.current.fillAlpha=h[1];this.ctx.globalAlpha=h[1];break;case "BM":d&&d.name&&"Normal"!==d.name?(h=d.name.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}).substring(1),this.ctx.globalCompositeOperation=h,this.ctx.globalCompositeOperation!==h&&v('globalCompositeOperation "'+h+'" is not supported')):this.ctx.globalCompositeOperation="source-over";break;case "SMask":this.current.activeSMask&&
this.endSMaskGroup(),this.current.activeSMask=d?this.tempSMask:null,this.current.activeSMask&&this.beginSMaskGroup(),this.tempSMask=null}}},beginSMaskGroup:function(){var a=this.current.activeSMask,b=L.getCanvas("smaskGroupAt"+this.groupLevel,a.canvas.width,a.canvas.height,!0),h=this.ctx,d=h.mozCurrentTransform;this.ctx.save();b=b.context;b.scale(1/a.scaleX,1/a.scaleY);b.translate(-a.offsetX,-a.offsetY);b.transform.apply(b,d);c(h,b);this.ctx=b;this.setGState([["BM","Normal"],["ca",1],["CA",1]]);this.groupStack.push(h);
...
Math.ceil(1048576/n)),y=0;y<g;y+=u){var G=Math.min(u,g-y),E=d.getImageData(0,y,n,G),G=a.getImageData(0,y,n,G);if(l)for(var B=E.data,D=m,A=Ba,p=k,C=B.length,I=3;I<C;I+=4){var F=B[I];if(0===F)B[I-3]=D,B[I-2]=A,B[I-1]=p;else if(255>F){var x=255-F;B[I-3]=B[I-3]*F+D*x>>8;B[I-2]=B[I-2]*F+A*x>>8;B[I-1]=B[I-1]*F+p*x>>8}}c(E.data,G.data);d.putImageData(G,0,y)}b.drawImage(h,0,0)}this.ctx.restore()},save:function(){this.ctx.save();var a=this.current;this.stateStack.push(a);this.current=a.clone();this.current.activeSMask=
null},restore:function(){0!==this.stateStack.length&&(null!==this.current.activeSMask&&this.endSMaskGroup(),this.current=this.stateStack.pop(),this.ctx.restore(),this.cachedGetSinglePixelWidth=null)},transform:function(a,b,c,h,d,k){this.ctx.transform(a,b,c,h,d,k);this.cachedGetSinglePixelWidth=null},constructPath:function(a,b){for(var c=this.ctx,h=this.current,d=h.x,k=h.y,n=0,e=0,g=a.length;n<g;n++)switch(a[n]|0){case m.rectangle:var d=b[e++],k=b[e++],l=b[e++],f=b[e++];0===l&&(l=this.getSinglePixelWidth());
0===f&&(f=this.getSinglePixelWidth());l=d+l;f=k+f;this.ctx.moveTo(d,k);this.ctx.lineTo(l,k);this.ctx.lineTo(l,f);this.ctx.lineTo(d,f);this.ctx.lineTo(d,k);this.ctx.closePath();break;case m.moveTo:d=b[e++];k=b[e++];c.moveTo(d,k);break;case m.lineTo:d=b[e++];k=b[e++];c.lineTo(d,k);break;case m.curveTo:d=b[e+4];k=b[e+5];c.bezierCurveTo(b[e],b[e+1],b[e+2],b[e+3],d,k);e+=6;break;case m.curveTo2:c.bezierCurveTo(d,k,b[e],b[e+1],b[e+2],b[e+3]);d=b[e+2];k=b[e+3];e+=4;break;case m.curveTo3:d=b[e+2];k=b[e+3];
c.bezierCurveTo(b[e],b[e+1],d,k,d,k);e+=4;break;case m.closePath:c.closePath()}h.setCurrentPoint(d,k)},closePath:function(){this.ctx.closePath()},stroke:function(a){a="undefined"!==typeof a?a:!0;var b=this.ctx,c=this.current.strokeColor;b.lineWidth=Math.max(.65*this.getSinglePixelWidth(),this.current.lineWidth);b.globalAlpha=this.current.strokeAlpha;c&&c.hasOwnProperty("type")&&"Pattern"===c.type?(b.save(),b.strokeStyle=c.getPattern(b,this),b.stroke(),b.restore()):b.stroke();a&&this.consumePath();
...
a/100},setLeading:function(a){this.current.leading=-a},setFont:function(a,b){var c=this.commonObjs.get(a),h=this.current;c||x("Can't find font for "+a);h.fontMatrix=c.fontMatrix?c.fontMatrix:S;0!==h.fontMatrix[0]&&0!==h.fontMatrix[3]||v("Invalid font matrix for font "+a);0>b?(b=-b,h.fontDirection=-1):h.fontDirection=1;this.current.font=c;this.current.fontSize=b;if(!c.isType3Font){var h=c.black?c.bold?"bolder":"bold":c.bold?"bold":"normal",d=c.italic?"italic":"normal",c='"'+(c.loadedName||"sans-serif")+
'", '+c.fallbackName,k=16>b?16:100<b?100:b;this.current.fontSizeScale=b/k;this.ctx.font=d+" "+h+" "+k+"px "+c}},setTextRenderingMode:function(a){this.current.textRenderingMode=a},setTextRise:function(a){this.current.textRise=a},moveText:function(a,b){this.current.x=this.current.lineX+=a;this.current.y=this.current.lineY+=b},setLeadingMoveText:function(a,b){this.setLeading(-b);this.moveText(a,b)},setTextMatrix:function(a,b,c,h,d,k){this.current.textMatrix=[a,b,c,h,d,k];this.current.textMatrixScale=
Math.sqrt(a*a+b*b);this.current.x=this.current.lineX=0;this.current.y=this.current.lineY=0},nextLine:function(){this.moveText(0,this.current.leading)},paintChar:function(a,b,c){var h=this.ctx,d=this.current,k=d.font,n=d.textRenderingMode,d=d.fontSize/d.fontSizeScale,e=n&3,n=!!(n&4),g;if(k.disableFontFace||n)g=k.getPathGenerator(this.commonObjs,a);k.disableFontFace?(h.save(),h.translate(b,c),h.beginPath(),g(h,d),0!==e&&2!==e||h.fill(),1!==e&&2!==e||h.stroke(),h.restore()):(0!==e&&2!==e||h.fillText(a,
b,c),1!==e&&2!==e||h.strokeText(a,b,c));n&&(this.pendingTextPaths||(this.pendingTextPaths=[])).push({transform:h.mozCurrentTransform,x:b,y:c,fontSize:d,addToPath:g})},get isFontSubpixelAAEnabled(){var a=document.createElement("canvas").getContext("2d");a.scale(1.5,1);a.fillText("I",0,10);for(var a=a.getImageData(0,0,10,10).data,b=!1,c=3;c<a.length;c+=4)if(0<a[c]&&255>a[c]){b=!0;break}return Q(this,"isFontSubpixelAAEnabled",b)},showText:function(a){var b=this.current,c=b.font;if(c.isType3Font)return this.showType3Text(a);
var h=b.fontSize;if(0!==h){var d=this.ctx,k=b.fontSizeScale,n=b.charSpacing,e=b.wordSpacing,g=b.fontDirection,l=b.textHScale*g,f=a.length,u=c.vertical,m=c.defaultVMetrics,p=h*b.fontMatrix[0],E=0===b.textRenderingMode&&!c.disableFontFace;d.save();d.transform.apply(d,b.textMatrix);d.translate(b.x,b.y+b.textRise);0<g?d.scale(l,-1):d.scale(l,1);var B=b.lineWidth,D=b.textMatrixScale;if(0===D||0===B){if(D=b.textRenderingMode&3,1===D||2===D)this.cachedGetSinglePixelWidth=null,B=.65*this.getSinglePixelWidth()}else B/=
D;1!==k&&(d.scale(k,k),B/=k);d.lineWidth=B;for(D=B=0;D<f;++D){var A=a[D];if(null===A)B+=g*e;else if("number"===typeof A)B+=-A*h*.001;else{var C=!1,x=A.fontChar,I=A.accent,F,M=A.width;if(u){var v;F=A.vmetric||m;v=A.vmetric?F[1]:.5*M;v=-v*p;A=F[2]*p;M=F?-F[0]:M;F=v/k;A=(B+A)/k}else F=B/k,A=0;c.remeasure&&0<M&&this.isFontSubpixelAAEnabled&&(C=1E3*d.measureText(x).width/h*k,v=M/C,C=!0,d.save(),d.scale(v,1),F/=v);E&&!I?d.fillText(x,F,A):(this.paintChar(x,F,A),I&&(x=F+I.offset.x/k,F=A-I.offset.y/k,this.paintChar(I.fontChar,
x,F)));B+=M*p+n*g;C&&d.restore()}}u?b.y-=B*l:b.x+=B*l;d.restore()}},showType3Text:function(a){var b=this.ctx,c=this.current,h=c.font,d=c.fontSize,k=c.fontDirection,n=c.charSpacing,e=c.wordSpacing,g=c.textHScale*k,l=c.fontMatrix||S,f=a.length,u;if(3!==c.textRenderingMode&&0!==d){b.save();b.transform.apply(b,c.textMatrix);b.translate(c.x,c.y);b.scale(g,k);for(k=0;k<f;++k)if(u=a[k],null===u)this.ctx.translate(e,0),c.x+=e*g;else if("number"===typeof u)u=.001*-u*d,this.ctx.translate(u,0),c.x+=u*g;else{var m=
h.charProcOperatorList[u.operatorListId];m?(this.processingType3=u,this.save(),b.scale(d,d),b.transform.apply(b,l),this.executeOperatorList(m),this.restore(),u=C.applyTransform([u.width,0],l)[0]*d+n,b.translate(u,0),c.x+=u*g):v('Type3 character "'+u.operatorListId+'" is not available')}b.restore();this.processingType3=null}},setCharWidth:function(a,b){},setCharWidthAndBounds:function(a,b,c,h,d,k){this.ctx.rect(c,h,d-c,k-h);this.clip();this.endPath()},getColorN_Pattern:function(a){return"TilingPattern"===
a[0]?new Ca(a,a[1],this.ctx,this.objs,this.commonObjs,this.baseTransform):da(a)},setStrokeColorN:function(){this.current.strokeColor=this.getColorN_Pattern(arguments)},setFillColorN:function(){this.current.fillColor=this.getColorN_Pattern(arguments);this.current.patternFill=!0},setStrokeRGBColor:function(a,b,c){a=C.makeCssRgb(a,b,c);this.ctx.strokeStyle=a;this.current.strokeColor=a},setFillRGBColor:function(a,b,c){a=C.makeCssRgb(a,b,c);this.ctx.fillStyle=a;this.current.fillColor=a;this.current.patternFill=
!1},shadingFill:function(a){var b=this.ctx;this.save();a=da(a);b.fillStyle=a.getPattern(b,this,!0);var c=b.mozCurrentTransformInverse;if(c){var b=b.canvas,h=b.width,d=b.height,b=C.applyTransform([0,0],c);a=C.applyTransform([0,d],c);var k=C.applyTransform([h,0],c),n=C.applyTransform([h,d],c),c=Math.min(b[0],a[0],k[0],n[0]),h=Math.min(b[1],a[1],k[1],n[1]),d=Math.max(b[0],a[0],k[0],n[0]),b=Math.max(b[1],a[1],k[1],n[1]);this.ctx.fillRect(c,h,d-c,b-h)}else this.ctx.fillRect(-1E10,-1E10,2E10,2E10);this.restore()},
...
beginGroup:function(a){this.save();var b=this.ctx;a.isolated||O("TODO: Support non-isolated groups.");a.knockout&&v("Knockout groups not supported.");var h=b.mozCurrentTransform;a.matrix&&b.transform.apply(b,a.matrix);a.bbox||x("Bounding box is required.");var d=C.getAxialAlignedBoundingBox(a.bbox,b.mozCurrentTransform),d=C.intersect(d,[0,0,b.canvas.width,b.canvas.height])||[0,0,0,0],k=Math.floor(d[0]),n=Math.floor(d[1]),e=Math.max(Math.ceil(d[2])-k,1),g=Math.max(Math.ceil(d[3])-n,1),l=d=1;4096<e&&
(d=e/4096,e=4096);4096<g&&(l=g/4096,g=4096);var f="groupAt"+this.groupLevel;a.smask&&(f+="_smask_"+this.smaskCounter++%2);e=L.getCanvas(f,e,g,!0);g=e.context;g.scale(1/d,1/l);g.translate(-k,-n);g.transform.apply(g,h);a.smask?this.smaskStack.push({canvas:e.canvas,context:g,offsetX:k,offsetY:n,scaleX:d,scaleY:l,subtype:a.smask.subtype,backdrop:a.smask.backdrop}):(b.setTransform(1,0,0,1,0,0),b.translate(k,n),b.scale(d,l));c(b,g);this.ctx=g;this.setGState([["BM","Normal"],["ca",1],["CA",1]]);this.groupStack.push(b);
this.groupLevel++},endGroup:function(a){this.groupLevel--;var b=this.ctx;this.ctx=this.groupStack.pop();void 0!==this.ctx.imageSmoothingEnabled?this.ctx.imageSmoothingEnabled=!1:this.ctx.mozImageSmoothingEnabled=!1;a.smask?this.tempSMask=this.smaskStack.pop():this.ctx.drawImage(b.canvas,0,0);this.restore()},beginAnnotations:function(){this.save();this.current=new la},endAnnotations:function(){this.restore()},beginAnnotation:function(a,b,c){this.save();R(a)&&4===a.length&&(this.ctx.rect(a[0],a[1],
a[2]-a[0],a[3]-a[1]),this.clip(),this.endPath());this.transform.apply(this,b);this.transform.apply(this,c)},endAnnotation:function(){this.restore()},paintJpegXObject:function(a,b,c){var h=this.objs.get(a);if(h){this.save();var d=this.ctx;d.scale(1/b,-1/c);d.drawImage(h,0,0,h.width,h.height,0,-c,b,c);this.imageLayer&&(h=d.mozCurrentTransformInverse,d=this.getCanvasPosition(0,0),this.imageLayer.appendImage({objId:a,left:d[0],top:d[1],width:b/h[0],height:c/h[3]}));this.restore()}else v("Dependent image isn't ready yet")},
paintImageMaskXObject:function(a){var b=this.ctx,c=a.width,h=a.height,k=this.current.fillColor,n=this.current.patternFill,e=this.processingType3;e&&void 0===e.compiled&&(e.compiled=1E3>=c&&1E3>=h?ra({data:a.data,width:c,height:h}):null);e&&e.compiled?e.compiled(b):(b=L.getCanvas("maskCanvas",c,h),e=b.context,e.save(),d(e,a),e.globalCompositeOperation="source-in",e.fillStyle=n?k.getPattern(e,this):k,e.fillRect(0,0,c,h),e.restore(),this.paintInlineImageXObject(b.canvas))},paintImageMaskXObjectRepeat:function(a,
b,c,h){var k=a.width,n=a.height,e=this.current.fillColor,g=this.current.patternFill,l=L.getCanvas("maskCanvas",k,n),f=l.context;f.save();d(f,a);f.globalCompositeOperation="source-in";f.fillStyle=g?e.getPattern(f,this):e;f.fillRect(0,0,k,n);f.restore();a=this.ctx;e=0;for(g=h.length;e<g;e+=2)a.save(),a.transform(b,0,0,c,h[e],h[e+1]),a.scale(1,-1),a.drawImage(l.canvas,0,0,k,n,0,-1,1,1),a.restore()},paintImageMaskXObjectGroup:function(a){for(var b=this.ctx,c=this.current.fillColor,h=this.current.patternFill,
k=0,e=a.length;k<e;k++){var n=a[k],g=n.width,l=n.height,f=L.getCanvas("maskCanvas",g,l),m=f.context;m.save();d(m,n);m.globalCompositeOperation="source-in";m.fillStyle=h?c.getPattern(m,this):c;m.fillRect(0,0,g,l);m.restore();b.save();b.transform.apply(b,n.transform);b.scale(1,-1);b.drawImage(f.canvas,0,0,g,l,0,-1,1,1);b.restore()}},paintImageXObject:function(a){(a=this.objs.get(a))?this.paintInlineImageXObject(a):v("Dependent image isn't ready yet")},paintImageXObjectRepeat:function(a,b,c,h){if(a=
this.objs.get(a)){for(var d=a.width,k=a.height,e=[],n=0,g=h.length;n<g;n+=2)e.push({transform:[b,0,0,c,h[n],h[n+1]],x:0,y:0,w:d,h:k});this.paintInlineImageXObjectGroup(a,e)}else v("Dependent image isn't ready yet")},paintInlineImageXObject:function(b){var c=b.width,h=b.height,d=this.ctx;this.save();d.scale(1/c,-1/h);var k=d.mozCurrentTransformInverse,n=k[0],e=k[1],n=Math.max(Math.sqrt(n*n+e*e),1),e=k[2],g=k[3],e=Math.max(Math.sqrt(e*e+g*g),1),l;if(b instanceof HTMLElement||!b.data)g=b;else{l=L.getCanvas("inlineImage",
c,h);var f=l.context;a(f,b);g=l.canvas}for(var m=c,u=h,y="prescale1";2<n&&1<m||2<e&&1<u;){var p=m,E=u;2<n&&1<m&&(p=Math.ceil(m/2),n/=m/p);2<e&&1<u&&(E=Math.ceil(u/2),e/=u/E);l=L.getCanvas(y,p,E);f=l.context;f.clearRect(0,0,p,E);f.drawImage(g,0,0,m,u,0,0,p,E);g=l.canvas;m=p;u=E;y="prescale1"===y?"prescale2":"prescale1"}d.drawImage(g,0,0,m,u,0,-h,c,h);this.imageLayer&&(d=this.getCanvasPosition(0,-h),this.imageLayer.appendImage({imgData:b,left:d[0],top:d[1],width:c/k[0],height:h/k[3]}));this.restore()},
paintInlineImageXObjectGroup:function(b,c){var h=this.ctx,d=b.width,k=b.height,e=L.getCanvas("inlineImage",d,k);a(e.context,b);for(var n=0,g=c.length;n<g;n++){var l=c[n];h.save();h.transform.apply(h,l.transform);h.scale(1,-1);h.drawImage(e.canvas,l.x,l.y,l.w,l.h,0,-1,1,1);this.imageLayer&&(l=this.getCanvasPosition(l.x,l.y),this.imageLayer.appendImage({imgData:b,left:l[0],top:l[1],width:d,height:k}));h.restore()}},paintSolidColorImageMask:function(){this.ctx.fillRect(0,0,1,1)},markPoint:function(a){},
